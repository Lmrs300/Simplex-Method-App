    ...
    <>
          ...
          >
            <label htmlFor="varDec">
              ...
              <input
                ...
                min="2"
                max="6"
                onChange={handlePrincipalInputs}
                value={principalInfo.varDec}
              />
            </label>
            <label htmlFor="rest">
              ...
              <input
                ...
                max="6"
                onChange={handlePrincipalInputs}
                value={principalInfo.rest}
              />
            </label>
            <button type="submit" className="btn_sig">
              Siguiente
            </button>
          </form>
        </>
      ...
      {pageForm == 2 ? (
        <SimplexForm2
          ...
          valTabla={valTabla}
          setValTabla={setValTabla}
          volverAntPag={volverAntPag}
      ...
      {pageForm == 4 ? (
        <TableList
          principalInfo={principalInfo}
          setPrincipalInfo={setPrincipalInfo}
          valTabla={valTabla}
          setValTabla={setValTabla}
          setPageForm={setPageForm}
        />
